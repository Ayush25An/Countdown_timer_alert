'''Create a Countdown timer in python with Start, Pause and Resets Button'''
...
class CountDown:
    def __init__(self, root):
        ...
        # Declaring a variable to pause and clear the countdown time
        self.pause = False
        self.clear = False
    ...
    def Get_Time(self):
        ...
        try:
            ...
            if s == 0 and m == 0 and h == 0:
                ...
                #Clear Button
                clear_button = Button(self.button_frame, text='Clear',
                font=('Helvetica',12),bg="red", fg="white",
                command=self.clear_time )
                clear_button.place(x=180, y=0)
    ...
    def clear_time(self):
        self.clear = True
        self.time_left = 0
        self.time_display.config(text=f"You Reset The Time !! ")
